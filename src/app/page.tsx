...
export default function HomePage() {
  ...
  useEffect(() => {
    if (canvasRef.current) {
      const { renderer } = setupThreeScene(canvasRef.current, "circle");
  ...
  return (
    <div className="min-h-screen flex bg-gray-900">
      <aside className="w-full md:w-1/3 p-6 overflow-y-auto border-r border-gray-300 dark:border-gray-700">
        ...
        <button
          className="w-full bg-primary text-primary font-medium py-2 px-4 rounded-lg transition-colors"
        ...
        <div className="p-4 rounded-lg border mt-6 bg-gray-800 border-gray-700">
          <div className="flex items-center justify-between mb-3">
            ...
            <button
              className="p-1.5 rounded-md transition-colors bg-gray-900"
